...
<div style="display:<?php if ($instance['stats_tag']['date']['active']) : ?>block<?php else: ?>none<?php endif; ?>; width:90%; margin:10px 0; padding:3% 5%; background:#f5f5f5;">
    ...
    <label title='l, j. F Y'><input type='radio' name='<?php echo $this->get_field_name('date_format'); ?>' value='l, j. F Y' <?php echo ($instance['stats_tag']['date']['format'] == 'l, j. F Y') ? 'checked="checked"' : ''; ?> /><?php echo date_i18n('l, j. F Y', time()); ?></label><br />
</div>
