...
if ( !class_exists('WordpressPopularPosts') ) {
	...
	class WordpressPopularPosts extends WP_Widget {
		 ...
		 * @var		array
		 */
		protected $botlist = array( "abcdatos", "acme", "adsbot-google", "ahoy", "alkaline", "ananzi", "anthill", "arachnophilia", "arale", "araneo", "araybOt", "architextSpider", "aretha", "ariadne", "arks", "aspider", "ask", "atn worldwide", "atomz", "auresys", "backrub", "bayspider", "bbot", "big brother", "bingbot", "bjaaland", "blackwidow", "bloodhound", "borg-bot", "bot", "boxseaBot", "bright.net", "bspider", "cactvs chemistry spider", "calif", "cassandra", "crawl", "crawler", "digimarc marcspider", "checkbot", "christcrawler.com", "churl", "cIeNcIaFiCcIoN.nEt", "cmc", "collective", "combine system", "computingSite robi", "conceptbot", "confuzzledbot", "coolbot", "cusco", "cyberSpyder", "cydralspider", "deepindex", "desert realm", "deweb", "dienstspider", "digger", "dnabot", "docomo", "dogpile", "dragonbot", "dwcp", "e-collector", "ebiness", "eit", "elfinbot", "emacs-w3", "esculapio", "esther", "evliya celebi", "nzexplorer", "facebookexternalhit", "fastcrawler", "feedfetcher", "felix", "ferret", "fetchrover", "fido", "kit-fireball", "fish", "fouineur", "freecrawl", "focusedcrawler", "funnelweb", "gammaspider", "gazz", "gcreep", "getterroboPlus", "getbot", "geturl", "gigabot", "golem", "google", "googlebot", "grapnel", "griffon", "gromit", "gulper", "hambot", "harvest", "havindex", "html index", "hometown", "html_analyzer", "htmlgobble", "hyper-decontextualizer", "iajabot", "ibm_planetwide", "iconoclast", "ia_archiver", "ingrid", "imagelock", "incywincy", "informant", "infoseek", "infospiders", "inktomi", "inspector", "intelliagent", "iron33", "israeli-search", "javabee", "jbot", "jcrawler", "jeeves", "jobo", "joebot", "Jubii", "jumpstation", "image.kapsi.net", "katipo", "kdd-explorer", "kilroy", "ko_yappo_robot", "labelgrabber", "larbin", "legs", "link validator", "linkscan", "linkwalker", "lockon", "logo.gif", "lycos", "mac wwwworm", "magpie", "marvin", "mattie", "mediafox", "mediapartners-google", "merzscope", "mindcrawler", "mnogosearch", "moget", "momspider", "monster", "moose", "motor", "msnbot", "muncher", "muninn", "muscat ferret", "mwd.search", "nec-meshexplorer", "nederland.zoek", "ndspider", "netcarta", "netmechanic", "netscoop", "newscan-online", "nhse", "nomad", "northern", "northStar", "nwi", "objectssearch", "occam", "hku", "ontospider", "openfind", "orb", "pack rat", "pageboy", "parasite", "patric", "pegasus", "peregrinator", "perlcrawler", "phantom", "phpdig", "piltdownman", "pimptrain.com", "pioneer", "portal", "pgp", "plumtreewebaccessor", "poppi", "portalb", "psbot", "python", "raven", "rbse", "resume", "roadhouse", "robot", "rixbot", "robbie", "robocrawl", "robofox", "robozilla", "roverbot", "rules", "safetynet", "scooter", "scrubby", "search", "search.aus-au.com", "searchprocess", "senrigan", "sg-scout", "shagseeker", "sift", "simmany", "sitetech-rover", "skymob.com", "slcrawler", "sleek", "slurp", "snooper", "solbot", "spanner", "spider", "spiderbot", "spiderline", "spiderman", "spider_monkey", "spiderview", "spry", "searcher", "suke", "suntek", "sven", "sygol", "tach", "tarantula", "tarspider", "tcl", "techbot", "templeton", "teomatechnologies", "titin", "titan", "tkwww", "tlspider", "ucsd", "udmsearch", "uptimebot", "valkyrie", "verticrawl", "victoria", "vision-search", "void-bot", "voyager", "vwbot", "wanderer", "walhello", "wired", "webcrawler", "w3m2", "w@pSpider", "webbandit", "webcatcher", "webcopy", "webfetcher", "webfoot", "webinator", "weblayers", "weblinker", "webmirror", "webquest", "webreaper", "webs", "websnarf", "webspider", "webvac", "webwalk", "webwalker", "webwatch", "wget", "whatuseek", "whowhere", "weblog", "w3mir", "w3index", "w3c_validator", "webstolperer", "wombat", "wwwc", "webzinger", "xget", "xyleme", "yandex", "yahoobot", "yahoo!", "zippy" );
