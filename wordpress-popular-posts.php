...
if (!class_exists('WordpressPopularPosts')) {
    ...
    class WordpressPopularPosts extends WP_Widget
    {
        ...
        public function update($new_instance, $old_instance)
        {
            ...
            $instance['shuffle_posts'] = isset($new_instance['shuffle_posts']);

            $instance['shuffle_posts_limit']['active'] = isset($new_instance['shuffle_posts_limit-active']);
            $instance['shuffle_posts_limit']['value'] = $new_instance['shuffle_posts_limit-value'];
        ...
        private function __get_popular_posts($instance)
        {
            ...
            if (!defined('WPP_ADMIN') && $this->user_settings['tools']['cache']['active']) {
                ...
                if (false === $mostpopular) {
                    ...
                    if ($instance['shuffle_posts'])
                        shuffle($mostpopular);

                    if ($instance['shuffle_posts'] && $instance['shuffle_posts_limit']['active'])
                        $mostpopular = array_slice($mostpopular, 0, $instance['shuffle_posts_limit']['value']);
